		...
		<div class="row">
			<div class="col-sm-12">
				<div class="fpbx-container">
					<div class="display full-border">
						<form class="fpbx-submit" action="?display=filestore" method="post" id="server_form" name="server_form" fpbx-delete="?display=filestore&driver=Local&action=delete&id=<?php echo isset($_GET['id']) ? $_GET['id'] : '' ?>">
