...
<form class="fpbx-submit" action="?display=filestore" method="post" id="server_form" name="server_form" fpbx-delete="?display=filestore&driver=SSH&action=delete&id=<?php echo $id ?>">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="port" name="port" value="<?php echo isset($port) ? $port : '22' ?>"<?php echo $disabled ?>>
						</div>
					</div>
				</div>
			</div>
