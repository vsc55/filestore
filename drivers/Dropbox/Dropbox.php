...
class Dropbox{
	...
	public function addItem($data){
		...
		$this->FreePBX->Filestore->setConfig($id,array('id' => $id, 'name' => $data['name'], 'desc' => $description),'dropboxservers');
	...
	public function deleteItem($id){
		$this->FreePBX->Filestore->setConfig($id,false,'dropboxservers');
	...
	public function listItems(){
		$items = $this->FreePBX->Filestore->getAll('dropboxservers');
	 ...
	 * @return        File object
	 */
	public function get($id,$remote,$dropbox){
		$dropbox = $this->translatePath($dropbox);
	 ...
	 */
	public function put($id,$dropbox,$remote){
		$dropbox = $this->translatePath($dropbox);
		$filesystem = $this->getConnection($id);
		try {
			$ret = $filesystem->put($remote, $dropbox);
		} catch (\Exception $e) {
			throw $e;
		}
		return $ret;
