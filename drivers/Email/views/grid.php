...
<table id="emailgrid"
  ...
  <thead>
    <tr>
      ...
      <th data-field="id" data-formatter="emailLinkFormatter" class="col_actions"><?php echo _("Actions")?></th>
    </tr>
  </thead>
</table>
<script>
function emailLinkFormatter(value, row, index){
    ...
    html += '&nbsp;<a href="?display=filestore&driver=Email&action=delete&id='+value+'" class="delAction"><i class="fa fa-trash-o"></i></a>';
    return html;
}
</script>
